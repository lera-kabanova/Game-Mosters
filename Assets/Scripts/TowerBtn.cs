    ...
    public void ShowInfo(string type)
    {
        ...
        switch (type)
        {
            case "Fire":
                ...
                //tooltip = string.Format("<color=orange><size=50><b>Fire</b></size></color>");
               tooltip = string.Format("<color=orange><size=35><b>Fire</b></size></color>\nDamage: {0} \nProc: {1}%\nDebuff duration: {2}sec \nTick time: {3} sec \nTick damage: {4}\nCan apply a DOT to the target", fire.Damage, fire.Proc, fire.DebuffDuration, fire.TickTime, fire.TickDamage);
                break;
            case "Frost":
                //tooltip = string.Format("<color=#00ffffff><size=50><b>Frost</b></size></color>");
                ...
                break;
            case "Poison":
                //tooltip = string.Format("<color=#00ff00ff><size=50><b>Poison</b></size></color>");
                ...
                break;
            case "Storm":
                //tooltip = string.Format("<color=#add8e6ff><size=50><b>Storm</b></size></color>");
